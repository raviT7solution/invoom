...
class AppliedDiscountsTest < ActionDispatch::IntegrationTest
  test "applied discount" do
    ...
    authentic_query mobile_user_token(user, device), applied_discount_create, variables: {
      input: {
  ...
  test "delete applied discount" do
    ...
    authentic_query mobile_user_token(user, device), applied_discount_delete, variables: {
